...
public class ViewController {
	...
	@PostMapping("/save")
	public GeneralResponse<ModuleResponse> saveFileds(@Valid @RequestBody ViewFieldRequest request)
	...
	public GeneralResponse<List<SystemViewFieldResponse>> getSystemFileds(@PathVariable Long viewId)
			throws ResourceNotFoundException {
	...
	public GeneralResponse<List<ViewCategoryResponse>> getAllCategories(@PathVariable("id") Long moduleId)
			throws ResourceNotFoundException {
	...
	public GeneralResponse<ViewCategoryResponse> getCategory(@PathVariable("id") Long categoryId)
			throws ResourceNotFoundException {
	...
	public GeneralResponse<List<ViewCategoryResponse>> deleteCategory(@PathVariable("id") Long categoryId)
			throws ResourceNotFoundException {
